...
Reference file for the `modern-frontend` skill. Covers smart/container vs presentational components, compound component pattern, Storybook documentation, Tailwind CSS configuration, responsive layouts, and CSS theming.
