...
description: >
  Use when the user is evaluating a job offer, negotiating salary, transitioning from IC to
  manager, considering internal mobility, changing companies, pivoting careers, or onboarding
  into a bigger role. Part of the career-* skill family.
triggers:
  - new job
  - offer evaluation
  - salary negotiation
